export default class Observable {
        ...
        private static createViewModel(obj, observeProperties, handler) {
                let viewModel = {};
        ...
        static make(obj: Object, observeProperties: string[]) {
                let map = [],
                        handler = Observable.getHanlder(map),
                        viewModel = Observable.createViewModel(obj, observeProperties, handler),
                        proxy = new Proxy(viewModel, handler);
        ...
        static addListener(obj: Object, property, callback) {
