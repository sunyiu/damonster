...
export function GetDefaultCards(): { monster: DaCard[]; hero: DaHeroCard[]; item: DaCard[]; skill: DaActionCard[] } {
	return {
		...
		item: [
			new DaItemCard(20, "ki1", 5, DaHeroTypes.Knight),
			new DaItemCard(21, "ki2", 5, DaHeroTypes.Knight),
			new DaItemCard(22, "ki3", 5, DaHeroTypes.Knight),
			new DaItemCard(23, "ki4", 5, DaHeroTypes.Knight),
			new DaItemCard(24, "wi6", 5, DaHeroTypes.Wizard),
			new DaItemCard(25, "wi7", 5, DaHeroTypes.Wizard),
			new DaItemCard(26, "wi8", 5, DaHeroTypes.Wizard),
			new DaItemCard(27, "wi9", 5, DaHeroTypes.Wizard),
			new DaItemCard(28, "ri11", 5, DaHeroTypes.Ranger),
			new DaItemCard(29, "ri12", 5, DaHeroTypes.Ranger),
			new DaItemCard(30, "ri13", 5, DaHeroTypes.Ranger),
			new DaItemCard(31, "ri14", 5, DaHeroTypes.Ranger),
